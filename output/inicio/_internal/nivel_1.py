...
def nivel_1(ingreso):
    ...
    l_troncos_der = troncos.crear_lista_troncos_der(40)
    l_troncos_izq = troncos.crear_lista_troncos_izq(40)
    l_autos_der = autos.crear_lista_autos_der(5,6000)
    l_autos_izq = autos.crear_lista_autos_izq(5,6800)
    ...
    while ejecutar:
        ...
        for evento in lista_eventos:
            ...
            if evento.type == pygame.USEREVENT:
                if evento.type == tiempo_objeto:
                    autos.mover_auto_der(l_autos_der,6000)
                    autos.mover_auto_izq(l_autos_izq,6800)
        ...
        if termino:
            ...
            puntos += 300
            punto = fuente_punto.render(f"Score: {puntos}",True,(0,0,0))
            nivel_2.nivel_2(ingreso,int(puntos),tiempo_total)
            ejecutar = False
            ...
            puntajes.agregar_jugador(ingreso,int(puntos),tiempo_total)
